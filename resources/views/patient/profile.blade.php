...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light justify-content-end">
             <span class="lead">Patient Dashboard</span>
        </nav>
        <!-- /.navbar -->
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- super admin-->
                            ...
                            <li class="nav-item">
                                <a href="{{route('patient.profileDetails') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{route('patient.doctorAppointments')}}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{route('patient.serviceAppointments')}}" class="nav-link">
                                    <i class="fa-solid fa-suitcase-medical mr-1"></i>
                                    <p>
