...
@section('template')
    ...
    <style>
        ...
        input {
            padding: 10px;
            font-family: "Open Sans", Verdana, sans-serif, FontAwesome;
            font-style: normal;
            font-weight: normal;
        ...
        ::placeholder {
            ...
            font-style: italic;
            /* Optionally, set the font style of the placeholder text */
        }
    </style>
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1 class="text-center">Welcome to Medilab</h1>
            <h4 class="text-center">Discover the best doctors based for your location and clinics closet to you.</h4>
            <div>
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <input type="text" class="form-control" name="searchedData"
                                placeholder="&#xf002; Search doctors for the nearest clinic and services">
                        </div>
                        <div class="col-2">
                    ...
                    <div class="col-5 offset-1" id="clinicList"></div>
                </form>
            </div>
        </div>
    </section><!-- End Hero -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="{{ count($specialties) }}"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Specialty</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="{{ count($serviceCount) }}"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Services</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="{{ count($patients) }}"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Patients</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    @foreach ($services as $service)
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="icon-box">
                                <div><img class="img-thumbnail" src="{{ asset('storage/' . $service->photo) }}" /></div>
                                <h4><a href="{{ route('patient.serviceDetails', $service->id) }}">{{ $service->name }}</a>
                                </h4>
                    ...
                    @foreach ($clinics as $clinic)
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="card" style="width: 18rem;">
                                <img src="{{ asset('patient/img/departments-1.jpg') }}" class="card-img-top"
                                    alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $clinic->name }}</h5>
                                    <p class="card-text">{{ $clinic->address }}</p>
                                    <button id="clinicBtn"><a href="#" class="text-decoration-none text-white">View
                                            more clinic services</a></button>
                                </div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="member d-flex align-items-start">
                                ...
                                <div class="member-info">
                                    ...
                                    <p>{{ Str::limit($doctor->experience, 50) }}</p>
                                    <div class="social">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.clinic').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "http://127.0.0.1:8000/patient/clinic/" + clinicId,
                    dataType: 'json',
                    success: function(response) {
                        console.log(response.status);
                        if (response.status == 'success') {
                            $('#clinicName').text(response.clinicData.name);
                            $('#clinicAddress').text(response.clinicData.address);
                            $('#opening').text(response.clinicData.opening_hour);
                        }
