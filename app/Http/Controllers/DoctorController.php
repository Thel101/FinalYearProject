...
class DoctorController extends Controller
{
    ...
    public function doctorList()
    {
        ...
        return view('admin.doctorList', compact('doctors', 'clinic', 'specialties'));
    }
    ...
    public function doctorSchedules(){
        ...
        return view('admin.doctorSchedule', compact('clinic','doctorSchedulesWithScheduleDays'));
    }
    ...
    public function doctorDetail($id)
    {
        ...
        // dd($doctor->toArray());
        return view('admin.doctorDetail', compact('doctor', 'clinic', 'doctorSpecialty','specialties'));
    }
